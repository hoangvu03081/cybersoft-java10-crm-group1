					...
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="dropdownId" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false"> ${ sessionScope.USER_LOGIN.fullname } </a>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label>Id</label>
								<input type="text" name="id" value="${ user.userId }" readonly class="form-control"
									placeholder="email" />
							</div>
							<div class="form-group">
								<label>Email</label>
							...
							<div class="form-group">
								<input type="text" name="returnServlet" value="${ returnServlet }" readonly
