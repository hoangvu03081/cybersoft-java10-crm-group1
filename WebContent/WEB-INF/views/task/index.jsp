                    ...
                    <tbody>
                    	<c:forEach items="${ taskList }" var="item" varStatus="listInformation">
	                        <tr>
	                            ...
	                            <td>${ item.userId }</td>
	                            <td>
	                                <a href="<%= request.getContextPath() %>/task/edit?id=${item.taskId}" class="btn btn-sm btn-info">
	                                    <i class="fa fa-pencil-square-o"></i>
	                                </a>
	                                <a href="<%= request.getContextPath() %>/task/delete?id=${item.taskId}" class="btn btn-sm btn-danger">
